			  ...
			  <div class=" product-menu-bar">
					...
					<div class="w_sidebar">
						<section class="sky-form">
							<h3>Categories</h3>
							<div class="row1 scroll-pane jspScrollable" style="overflow: hidden; padding: 0px; width: 255px;" tabindex="0">
								
								
							<div class="jspContainer" style="width: 255px; height: 154px;"><div class="jspPane" style="padding: 0px; width: 286px; top: 0px;"><div class="col col-4">
									<label class="checkbox"><input type="checkbox" name="checkbox" checked=""><i></i>Todos</label>
								</div><div class="col col-4">								
									<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Perros</label>
									<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Gatos</label>	
								</div></div><div class="jspVerticalBar"><div class="jspCap jspCapTop"></div><div class="jspTrack" style="height: 154px;"><div class="jspDrag" style="height: 153px;"><div class="jspDragTop"></div><div class="jspDragBottom"></div></div></div><div class="jspCap jspCapBottom"></div></div></div></div>
						</section>
					</div>
				</div>
			  </div>	
